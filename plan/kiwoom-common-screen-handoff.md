...
현재 12~15는 `AT-CH-001 답변 3상태`와 `AT-ST-001~003`이다. 공통화면 장표는 25~34로 새로 그렸다.

**2026-08-17 재정렬.** 위 갱신이 적은 "End of Document를 35로 옮겼다"는 파일에 반영돼 있지
않았고, 24~27번이 옛 부록·End와 같은 좌표에 겹쳐 있었다(충돌 4쌍). 실제로 재정렬했다 —
부록 4장 `36~39`, End of Document `40`. 신규 장표 2장: `23 · AT-CH-004 설정 모드`(구현 실측),
`35 · AT-CV-001 캔버스 창 기본`(현행 카드 6슬롯). 25~34는 그대로다. 05 구조도·06 목록도
실측에 맞췄다 — 설정 카드(AT-ST)는 캔버스 창이 아니라 대화 창 설정 모드 소속으로 정정,
ST 범례 정정, 목록에 23~35 행 추가.
