...
> 최종 갱신: 2026-08-19 · 브랜치 `디자인` (10차 — 글자 크기 5단계. 8차 리퀴드 글래스 전면 교체·9차 커맨드 카드 포함, 병합 전 이력은 아래 유지) — **`디자인` 브랜치 병합 완료.** 두 갈래가 합류했다:
...
**2026-08-19 (10차·디자인) · 글자 크기 5단계 설정 후 재실측 — 이 수치가 현행이다:**
