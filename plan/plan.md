...
| # | 작업 | 근거 |
|---|---|---|
| ~~19~~ | ~~**Paper 보드 8쪽(1M-0) 컬럼4 재작업**~~ → **완료(2026-08-18)** | 위 2차 지시 블록 참조 |
| ~~20~~ | ~~**Paper 보드 40쪽(6RX-0)에 창 제어 버튼 반영**~~ → **완료(2026-08-18)** | 목업 우상단 − · □ · × 크롬 + 배지 ⑥, Desc 5·6 병합으로 "창 제어 버튼" 항목 신설, 스트립·각주 갱신. `AT-CH-001-창-조작-이력.md` "추가" 절 참조 |
