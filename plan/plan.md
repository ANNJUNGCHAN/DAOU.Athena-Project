...
> 최종 갱신: 2026-08-19 · 브랜치 `디자인` (9차 — AT-CH-001R 커맨드 카드. 8차 리퀴드 글래스 전면 교체 포함, 병합 전 이력은 아래 유지) — **`디자인` 브랜치 병합 완료.** 두 갈래가 합류했다:
...
**2026-08-19 (9차·디자인) · AT-CH-001R 커맨드 카드 개편 후 재실측 — 이 수치가 현행이다:**
