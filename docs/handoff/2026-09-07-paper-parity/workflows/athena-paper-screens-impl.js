export const meta = {
  name: 'athena-paper-screens-impl',
...
const COMMON = `
## 공통 환경·규칙
- 작업 저장소(워크트리): ${WT} (브랜치 feat/paper-gates-2026-09-06, origin/main과 같은 선). 모든 파일 경로·git 명령은 이 워크트리 기준 절대경로로 쓴다. ${MAIN}(주 체크아웃)과 C:/Projects/DAOU.Athena-parity(다른 수정 트랙이 동시에 쓰는 워크트리)는 절대 수정·커밋하지 마라.
...
function implPrompt(b) {
  const procedure = b.kind === 'followup'
