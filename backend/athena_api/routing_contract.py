...
class CapabilityKind(StrEnum):
    ...
    ACCOUNT_CASH_MARGIN = "account_cash_margin"
    ACCOUNT_SETTLEMENT_FORECAST = "account_settlement_forecast"
    ACCOUNT_WITHDRAWAL_CAPACITY = "account_withdrawal_capacity"
    ACCOUNT_HOLDINGS = "account_holdings"
    ACCOUNT_TODAY_REUSE = "account_today_reuse"
    ACCOUNT_PURCHASE_SETTLEMENT = "account_purchase_settlement"
    ETF_NAV = "etf_nav"
    ETF_INFORMATION = "etf_information"
    ETF_FLOW = "etf_flow"
    ELW_PAYOFF = "elw_payoff"
    ELW_LIQUIDITY_LEVERAGE = "elw_liquidity_leverage"
    ELW_UNDERLYING_BASKET = "elw_underlying_basket"
    ELW_VALUATION_RIGHTS = "elw_valuation_rights"
