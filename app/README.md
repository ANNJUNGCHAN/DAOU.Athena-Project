...
| 조작 | 방법 | 구현 |
|---|---|---|
| 창 이동 | **크롬을 잡고 드래그** — 대화 창 컨트롤 스트립·설정/주문 헤더, 캔버스 상단 스트립 | 네이티브 캡션(`-webkit-app-region: drag`, 2026-08-19 표준화) — 이동은 OS가 수행, 가장자리 끌기 스냅 포함. 구판 커서 폴링(`athena:window-drag`)은 폐기 |
