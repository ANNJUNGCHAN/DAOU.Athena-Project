// ⚠ 2026-09-08 스펙 경로 폐기 이후 이 시나리오의 지도·시각 설계 단계(스펙 경로 언급
// 17곳)는 없는 화면을 누른다. 모델이 부르던 visual_question·visual_patch 툴도 서버에서
// 사라졌다. 현행 동선(보드 19~32)에 맞춘 시나리오로 다시 써야 한다.
//
