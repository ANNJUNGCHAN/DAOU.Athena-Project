...
const ROUTES = Object.freeze([
  ...
  },
  {
    ...
    // 「결과 데이터셋 1장을 찾지 못했습니다…」도 적지 않는다 — 앱은 실제로 못 읽은
    // 항목의 이름으로 그 줄을 만들어서(session-restore.js restoreReport), Paper의
    // 그 한 줄이 글자 그대로 만들어지는 봉투가 없다.
    phrases: ['백테스트', '전략 폼', 'restored', '일부만 복원했습니다', '다시 시도', '이대로 열기'],
