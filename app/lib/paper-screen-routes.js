...
const ROUTES = Object.freeze([
  ...
  },
  {
    ...
    // 배치 주기·수동 실행 두 행은 안 적는다 — 2026-09-08부터 앱은 그 행을 지우고
    // 조회 주기·수동 실행·실행 시각을 수집원 세 칸 각각에 붙였다(Paper 보드는 아직
    // 옛 두 행을 그리고 있어 문장이 다르다). 「브레인 준비됨」도 안 적는다: 배지
    // 문구가 백엔드 기동 여부로 갈려 이 검사에서 못 박을 수 없다.
    phrases: [
      '그래프 수집과 노출',
      '무엇을 읽고 누구에게 보일지',
      '보유잔고',
