...
const ROUTES = Object.freeze([
  ...
  },
  {
    ...
    root: '#shell',
    phrases: ['요약', '수집·노출', '메티스 · 그래프', '답이 캔버스를 바꿉니다'],
  ...
  // ---------- 모드·빈 화면 2장 (1-0) ----------
  {
    ...
    phrases: ['아고라 · 대화', '메티스 · 그래프', '아이기스 · 에이전트', '에르가네 · 플러그인', '팔라스 · 백테스트'],
  ...
  // ---------- 창·대화 턴·탭 3장 (1-0) ----------
  {
    ...
    phrases: ['새 대화', '메티스', '아이기스', '에르가네', '무엇이든 물어보세요'],
  ...
  },
  {
    ...
    phrases: ['복원 실패', '메티스', '아이기스', '에르가네', '무엇이든 물어보세요'],
...

  {
    ...
    // 걷어낸 뒤로 앱이 그리지 않는다.
    phrases: ['메티스', '아이기스', '에르가네', '주기 확인', '감시 조건',
      '값은 발화 시점 기준입니다 — 최신 확인은 다시 물어봐 주세요.'],
