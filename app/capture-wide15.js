...
//
// app/verify.js 검증10(app/verify.js:528-573)의 경로를 그대로 재사용한다 —
...
app.whenReady().then(async () => {
  ...
  const report = {
    ...
    method: "app/capture-wide15.js — verify.js 검증10(app/verify.js:528-573) 경로를 15 TR 전부로 확장. canvasWin에 athena:add-canvas-live를 직접 주입 → renderMcpTable → webContents.capturePage().",
